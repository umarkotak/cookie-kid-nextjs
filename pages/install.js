export default function InstallPage() {
  return (
    <main className="max-w-xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Cara Instal Ca Bocil</h1>

      {/* iOS Section */}
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">📱 iPhone atau iPad (Safari)</h2>
        <p>Ikuti langkah-langkah berikut untuk menambahkan Ca Bocil ke layar utama:</p>
        ...
        <p className="mt-3">Sekarang Ca Bocil bisa dibuka langsung dari layar utama iPhone/iPad Anda!</p>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">Sekarang Ca Bocil tersedia di layar utama Android Anda!</p>
      </section>
    </main>
  )
}
